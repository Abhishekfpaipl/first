<template>
    <div class="container-fluid d-flex flex-md-row justify-content-center mt-3 flex-column">

        <BillingAddress></BillingAddress>
        <button class="btn" data-bs-toggle="offcanvas" data-bs-target="#staticBackdropDelivery" aria-controls="staticBackdropDelivery"
        ...
        <div class="mb-3 p-2">
            ...
            <!-- Add Address canvas -->
            <div class="offcanvas offcanvas-end" data-bs-backdrop="static" tabindex="-1" id="staticBackdropDelivery"
                aria-labelledby="staticBackdropLabel">
                <div class="offcanvas-header">
                    <h5 class="offcanvas-title" id="staticBackdropLabel">Delivery Details</h5>
            ...
            <div v-for="(address, index) in savedAddresses" :key="index" class="my-3 d-flex justify-content-between">
                <div class="border-bottom card rounded-0 p-2 w-100">
                    <div class="d-flex justify-content-between">
                        <label :for="'DeliveryAddress' + index" class="pe-5 ">{{ address }}</label>
                        <input name="DeliveryAddress" :id="'DeliveryAddress' + index" type="radio">
                    </div>
...
import AddAddress from '@/mixins/AddAddress.js'
export default {
    name: "AddressPage",
    mixins:[AddAddress],
    data() {
        return {
            ...
            savedAddresses: [
            "Metro Fashion Okhla Factory, 9999437620, B-74 Pocket X, Okhla Phase II Okhla Industrial Estate, 110020, New Delhi, Delhi,  Harkesh Nagar Metro Station",
            ],
            editingIndex: -1,
        };
    },
    components: { PickUpAddress, BillingAddress },
}
</script>

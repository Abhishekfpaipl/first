<template>
    <div>
        <!-- <div class="d-flex justify-content-between align-items-center bg-light border p-2">
            <div class="d-flex fw-bold">
                <router-link to="/orders/completed" class="text-dark">
                    <i class="bi bi-arrow-left-short fs-3"></i>
                </router-link>
                <p class="m-2 mb-0">Completed Orders</p>
                <p class="m-2">OID: {{ complete.oid }}</p>
            </div>
            <div class="">
                <p class="m-0" style="font-size: 10px;">{{ complete.datetime }}</p>
            </div>
        </div> -->
        ...
        <div class="d-flex flex-column align-items-start bg-light border p-2"
            ...
            <div class="d-flex fw-bold">
                ...
                <p class="m-2 mb-0">Completed Orders</p>
                <p class="m-2 ms-0">ID: {{ complete.oid }}</p>
            </div>
            <!-- <div style="margin-left: 30px; margin-top: -5px;">
                <p class="m-0" style="font-size: 10px;">{{ order.datetime }}</p>
            </div> -->
        </div>

        <div class="container  mt-4">
            <!-- <div class="row">
                <img :src="complete.img" style="height: 160px; width: 160px;object-fit: fill;">
            </div> -->
            ...
            <div class="">
                ...
                <router-link :to="'/ProductPage/' + complete.catelog_id" class="text-decoration-none text-dark">
                    <button class="btn  w-100 d-flex justify-content-between align-items-center px-4 my-4"
                        style="background-color: #EFA3A7; box-shadow: rgba(67, 71, 85, 0.27) 0px 0px 0.25em, rgba(90, 125, 188, 0.05) 0px 0.25em 1em;">
                        ...
                        <div class="rounded-circle">
                            <div type="button" class="">
                                <img class="rounded-circle" :src="sub.img"
                                    style="height:60px; width:60px; object-fit: cover; object-position: top; margin-right:12px ;box-shadow: rgba(67, 71, 85, 0.27) 0px 0px 0.25em, rgba(90, 125, 188, 0.05) 0px 0.25em 1em;">
                            </div>
                        </div>
                    </div>
...
export default {
    ...
    computed: {
        complete() {
            ...
            return this.$store.getters.getcomplete(completeId);
        },
    }
}
</script>

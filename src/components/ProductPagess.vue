    ...
    <div class="main row">
      ...
      <div class="col-8">
        ...
        <div class="">
          ...
          <div
            class="btn d-flex justify-content-between p-2 mt-4"
            style="border-style: dashed !important; border: 2px"
          >
          ...
          <div class="text-start">
            <a
              href=""
              class="me-2"
              style="text-decoration: none; font-size: 10px; color: hotpink"
              >FULL COVERAGE BRAS |</a
            >
            <a
              href=""
              class="me-2"
          ...
          <div class="d-flex flex-column border border-2 mt-4">
            ...
            <a
              href=""
              class="text-uppercase text-start ms-4 fw-normal"

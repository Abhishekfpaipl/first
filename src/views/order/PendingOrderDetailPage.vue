    ...
    <div class="" style="padding-bottom: 100px;">
        ...
        <div class="container">
            <div class="" v-for="(pay, index) in order.payment" :key="index">
                ...
                <div class="d-flex justify-content-between gap-3">
                    <div class="w-100 d-flex justify-content-between mt-2">
                        ...
                        <label class="btn btn-outline-danger rounded-0 w-100 " style="opacity: 80%;" for="Bank">Bank</label>
                    </div>
                    <div class="w-100 d-flex justify-content-between  mt-2">
                        ...
                        <label class="btn btn-outline-danger rounded-0 w-100" style="opacity: 80%;" for="Upi">Upi</label>
                    </div>
                </div>
            ...
            <div class="" v-for="(del, index) in order.delivery" :key="index">
                <p class="ms-2 m-0 fs-3 mt-4">Delivery Details</p>
                <div class="mt-2 ">
                    <table class="table table-borderless">
                        <tbody>
                            <tr>
            ...
            <POrderSummary :order="order"></POrderSummary>
            <POrderCatalogs :order="order"></POrderCatalogs>
        </div>
    </div>
</template>

<script>
import POrderCatalogs from '@/components/Orders/POrderCatalogs.vue';
import POrderSummary from '@/components/Orders/POrderSummary.vue';

<template>
    <div class="container-fluid d-flex flex-md-row justify-content-center mt-5 flex-column">
        ...
        <!-- <p class="m-0 mt-2 text-center text-uppercase fw-bold">Select your delivery address</p> -->
        <div class="mb-3 p-2">
            ...
            <!-- <div v-for="(add, index) in address" :key="index"
                ...
                <div class="border-bottom card rounded-0 p-2">
                    <div class="d-flex justify-content-between">
                        <span class="fw-bold">{{ add.name }}</span>
                        <span><input :type="add.type"></span>
                    </div>
                    <div class="d-flex align-items-center">
                        <p class=" pe-5" style="max-width: 500px;">{{ add.address }}</p>

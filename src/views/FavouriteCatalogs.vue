                        ...
                        <div class="card-footer rounded-0 p-0" style="">
                            <div class="btn-group w-100 overflow-hidden"
                                ...
                                <div class="w-50 border-end">
                                    <button type="button" class="btn btn-danger rounded-0 w-100 h-100" style="padding: 3px;"
...
<script>
import SavedProductTopnav from '@/components/NavBar/SavedProductTopnav.vue';
